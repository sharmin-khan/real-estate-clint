  ...
  const handleSearch = async () => {
    ...
    try {
      const res = await fetch(
        `https://reak-estate-server.vercel.app/properties/search?location=${location}`
      );
      ...
      if (res.status === 404) {
        ...
        setMessage("");
        setSearchActive(true); // ✅ modal open 
      }
    } catch (err) {
      console.error(err);
      setSearchResults([]);
  ...
  return (
    <div className="my-12">
      <div className="text-center mb-10">
        <h2 className="text-2xl lg:text-3xl font-bold">Search by Location</h2>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6 ">
        <div className="flex flex-col md:flex-1 gap-4 w-full">
          ...
          <p className="text-gray-600 dark:text-gray-300  text-sm md:text-lg">
            ...
            interested in. Our system will search for verified properties <br />
            in the specified location and display relevant results instantly.
            This helps you find properties that match your preferences quickly
            and efficiently.
          </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-r from-green-500 to-green-900 bg-opacity-50">
          <div className="bg-white rounded-lg w-full max-w-6xl p-6 relative shadow-lg overflow-y-auto max-h-[90vh]">
            ...
            <button
              ...
              className="absolute top-0 right-2 flex items-center justify-center text-3xl md:text-4xl font-extrabold text-red-500 transition cursor-pointer"
            >
              ×
            </button>
            ...
            {searchResults.length === 0 ? (
              ...
              <div className="md:mt-6 mt-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 rounded-md">
